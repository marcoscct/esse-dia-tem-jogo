        ...
        <div className="bg-[#111111] rounded-3xl p-6 md:p-10 border border-zinc-800 shadow-2xl space-y-8 text-zinc-300 leading-relaxed text-sm md:text-base">
          ...
          <section className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 p-6 bg-zinc-950 border border-zinc-900 rounded-2xl">
              ...
              <div className="space-y-2 text-center md:text-left">
                <span className="text-xs text-zinc-400 block font-bold uppercase tracking-widest">{t.creators_label}</span>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-zinc-950 p-5 rounded-2xl border border-zinc-900 flex items-center gap-4">
              ...
              <div>
                <span className="text-xs text-zinc-400 block font-bold uppercase tracking-wider">{t.email_label}</span>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <span className="text-[10px] text-zinc-400">{t.youtube_sub}</span>
              </a>
              ...
              >
                ...
                <span className="text-[10px] text-zinc-400">{t.instagram_sub}</span>
              </a>
              ...
              >
                ...
                <span className="text-[10px] text-zinc-400">{t.twitter_sub}</span>
              </a>
            </div>
          </section>
