export const es = {
  ...
  "support": "Apoyar",
  "support_desc": "¿Te gusta el sitio? Apoya el mantenimiento del proyecto haciendo una contribución de cualquier valor.",
  "support_button": "Apoyar con PIX",
  "support_modal_title": "¿Te gusta ¿Este Día Hay Partido?? ⚽",
  "support_modal_desc": "El alojamiento, la base de datos y las APIs de este sitio se mantienen de forma independiente. Si la herramienta te ayudó a planificar tus compromisos o evitar inconvenientes con la familia, considera apoyar el mantenimiento del proyecto con cualquier cantidad.",
  "support_modal_action": "Apoyar con PIX",
  "devlog": "Novedades",
  "privacy": "Privacidad",
