export const pt = {
  ...
  "support": "Apoiar",
  "support_desc": "Gostou do site? Apoie a manutenção do projeto com um PIX de qualquer valor.",
  "support_button": "Apoiar no PIX",
  "support_modal_title": "Apoie o Esse Dia Tem Jogo! ⚽",
  "support_modal_desc": "A hospedagem, o banco de dados e as APIs do site são mantidos de forma independente. Se a ferramenta te ajudou a planejar seus compromissos ou evitar furos com a família, considere apoiar o projeto com uma contribuição de qualquer valor.",
  "support_modal_action": "Apoiar via PIX",
  "devlog": "Novidades",
  "privacy": "Privacidade",
